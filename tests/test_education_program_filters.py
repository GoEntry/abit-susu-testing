...
def test_education_program_filters(driver):
    ...
    print(level_filtered_count)
    assert level_filtered_count == 6
    ...
    print(division_filtered_count)
    assert division_filtered_count == 1
    time.sleep(0.5)
